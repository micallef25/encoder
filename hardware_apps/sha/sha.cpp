...
#pragma HLS pipeline II=1
	...
	interface_stream_out.write( (uint10_t)(input[i] | DONE_BIT_9) );
}

/*
*
*/
void producer(hls::stream<uint10_t> &producer_stream_in, hls::stream<uint33_t> &producer_stream_out)
{
